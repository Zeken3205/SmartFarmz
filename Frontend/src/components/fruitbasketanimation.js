...
import animationData from '../Assets/fruit-basket.json'; // Replace with the path to your JSON animation file

function Fruitbasketanimation() {
...
export default Fruitbasketanimation;
